...
// Create a mock entity manager with query builder
const mockQueryBuilder = {
  ...
  getMany: jest.fn(),
  getResultList: jest.fn(), // Add this method for MikroORM compatibility
};
...
describe('AuditRepository', () => {
  ...
  describe('findWithFilters', () => {
    ...
    it('should filter by queryId with partial matching', async () => {
      const mockLogs = [{ id: 'log-1' }];
      mockQueryBuilder.getResultList.mockResolvedValue(mockLogs);
